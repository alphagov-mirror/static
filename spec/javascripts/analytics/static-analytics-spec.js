describe("GOVUK.StaticAnalytics", function() {
  ...
  describe('when created', function() {
    ...
    describe('stripping date PII', function () {
      it('is off by default', function() {
        expect(analytics.analytics.stripPII.stripDatePII).toEqual(false);
      });
      ...
      it('can be configured directly', function() {
        ...
        expect(analytics.analytics.stripPII.stripDatePII).toEqual(true);
      });
    ...
    describe('stripping postcode PII', function () {
      it('is off by default', function() {
        expect(analytics.analytics.stripPII.stripPostcodePII).toEqual(false);
      });
      ...
      it('can be configured directly', function() {
        ...
        expect(analytics.analytics.stripPII.stripPostcodePII).toEqual(true);
      });
  ...
  describe("when the consent cookie has been set", function() {
    ...
    it('does set analytics cookies as normal when usage cookies are allowed', function() {
      ...
      expect(analytics.analytics.stripPII.stripDatePII).toBe(false)
      expect(analytics.analytics.stripPII.stripPostcodePII).toBe(false)
    });
  });
